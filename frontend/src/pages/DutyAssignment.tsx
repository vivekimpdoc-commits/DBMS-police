...
function VehicleStatus() {
  ...
  return (
    <div className="bg-slate-900/60 backdrop-blur-xl border border-white/8 rounded-3xl p-6 flex-1 min-w-[300px] xl:max-w-sm">
          ...
          <div key={i} className="flex flex-col gap-1.5 relative">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-200">{v.type} - {v.num}</p>
