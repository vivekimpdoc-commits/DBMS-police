      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass-card rounded-2xl p-6 flex flex-col">
          ...
          <div className="space-y-4 overflow-y-auto flex-1 pr-2">
            {incidents.map(inc => (
              <div key={inc.id} className="bg-slate-800/50 border border-slate-700 rounded-xl p-4 flex gap-4 hover:border-slate-500 transition-colors cursor-pointer group">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-400 mb-2">Location: <span className="text-white">{inc.location}</span> | Reporter: <span className="text-white">{inc.reportedBy}</span></p>
                  <div className="flex gap-2">
                    ...
                    <button className="text-xs px-2 py-1 bg-slate-700 text-slate-300 rounded border border-slate-600 hover:bg-slate-600 hover:text-white flex items-center gap-1">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="glass-card border-red-500/30 rounded-2xl p-6">
            ...
            <div className="bg-red-950/50 border border-red-800 rounded-xl p-4">
              ...
              <p className="text-slate-400 text-sm mb-3">Zone 2, Checkpost 4 (Medical Emergency)</p>
              <div className="flex gap-2">
          ...
          <div className="glass-card rounded-2xl p-6 flex-1 flex flex-col">
            ...
            <div className="flex-1 bg-slate-900/50 rounded-xl border border-slate-700 p-4 mb-4 flex flex-col justify-end space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <div className="bg-slate-800 p-3 rounded-2xl rounded-tl-sm text-sm text-slate-300">Zone 1 clear, convoy passing CP-3.</div>
              </div>
              <div className="flex gap-3 flex-row-reverse">
                ...
                <div className="bg-emerald-800/20 border border-emerald-500/20 p-3 rounded-2xl rounded-tr-sm text-sm text-emerald-100">Copy that Z1. Maintain perimeter.</div>
              </div>
            </div>
            <div className="flex gap-2">
              <input type="text" placeholder="Type message..." className="flex-1 bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500" />
