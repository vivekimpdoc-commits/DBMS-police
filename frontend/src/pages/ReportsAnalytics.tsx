    ...
    <div className="p-6 h-[calc(100vh-80px)] flex flex-col overflow-y-auto">
      <div className="flex justify-between items-center mb-6 shrink-0">
        ...
        <div className="flex gap-3">
          <button className="bg-slate-800 hover:bg-slate-700 text-slate-300 px-4 py-2 rounded-lg font-medium flex items-center gap-2 border border-slate-700 transition-colors">
        ...
        <div className="glass-card rounded-2xl p-6">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={idx} className="flex justify-between items-center bg-slate-800/50 p-3 rounded-lg border border-slate-700">
                <div>
                  <p className="text-white text-sm font-medium">{doc.name}.pdf</p>
                  <p className="text-slate-400 text-xs">{doc.date} • {doc.size}</p>
                </div>
                <button className="text-slate-400 hover:text-white bg-slate-700 p-2 rounded-md"><Download size={14}/></button>
              </li>
            ))}
          </ul>
        ...
        <div className="glass-card rounded-2xl p-6">
          ...
          <div className="space-y-4 mt-6">
            ...
            <div>
              ...
              <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden"><div className="h-full bg-indigo-500 w-[25%]"></div></div>
            </div>
            <div>
              <div className="flex justify-between text-xs text-slate-400 mb-1">
              ...
              <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden"><div className="h-full bg-orange-400 w-[10%]"></div></div>
            </div>
          </div>
        </div>
      </div>
