    ...
    <div className="min-h-screen bg-[#020817] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      >
        ...
        <div className="bg-slate-50/80 backdrop-blur-3xl border border-slate-200 p-10 rounded-[36px] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.8)]">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 w-4 h-4 group-focus-within:text-blue-400 transition-colors" />
                <input
                  type="password"
                  placeholder="••••••••"
          ...
          <p className="text-center text-[11px] font-bold text-slate-600 mt-8 uppercase tracking-[0.2em]">
            {t('restricted')}
          </p>
        </div>
      </motion.div>
