      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700 rounded-2xl p-6 flex-1 flex flex-col">
            ...
            <div className="flex-1 bg-slate-900 border border-slate-700 rounded-xl p-4 flex flex-col gap-3">
               ...
               <div className="bg-slate-800 border border-slate-700 rounded-lg p-3 flex gap-3 items-center opacity-70">
                 ...
                 <div>
                   ...
                   <p className="text-slate-300 text-xs">Camera: Entry A</p>
                 </div>
               </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 bg-slate-800/50 backdrop-blur-md border border-slate-700 rounded-2xl p-6 flex flex-col">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              ...
              <select className="bg-slate-900 border border-slate-700 text-slate-300 text-xs rounded px-2">
          ...
          <div className="flex-1 bg-slate-950 rounded-xl border border-slate-700 relative overflow-hidden group">
          ...
          <div className="grid grid-cols-4 gap-4 mt-4">
            {[1,2,3,4].map(i => (
              <div key={i} className={`h-20 bg-slate-900 rounded-lg border cursor-pointer hover:border-blue-500 transition-colors ${i === 1 ? 'border-blue-500' : 'border-slate-700'}`}>
