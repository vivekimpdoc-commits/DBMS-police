    ...
    <div className="p-6 h-[calc(100vh-80px)] flex flex-col">
      <div className="flex justify-between items-center mb-6 shrink-0">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Predictive analytics, Drone feeds, and Facial Recognition.</p>
        </div>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          {/* Predictive Manpower */}
          <div className="bg-slate-50/50 backdrop-blur-md border border-slate-200 rounded-2xl p-6">
            <h3 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2"><TrendingUp size={20} className="text-blue-400"/> AI Manpower Prediction</h3>
            <div className="space-y-4">
              <div className="bg-white border border-slate-200 rounded-xl p-4">
                <p className="text-slate-500 text-xs uppercase mb-1">Upcoming Event: CM Rally</p>
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-2xl font-bold text-slate-800">4,250</p>
                    <p className="text-xs text-slate-500">Suggested Deployment</p>
                  </div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed border-l-2 border-purple-500 pl-3">
          ...
          <div className="bg-slate-50/50 backdrop-blur-md border border-slate-200 rounded-2xl p-6 flex-1 flex flex-col">
            <h3 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2"><ScanFace size={20} className="text-emerald-400"/> Face Recognition Alerts</h3>
            <div className="flex-1 bg-white border border-slate-200 rounded-xl p-4 flex flex-col gap-3">
               <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3 flex gap-3 items-center">
                 <div className="w-12 h-12 bg-slate-50 rounded-lg overflow-hidden border border-red-500">
                 ...
                 <div>
                   ...
                   <p className="text-slate-600 text-xs">Camera: Gate 2 CCTV</p>
                   <p className="text-slate-500 text-[10px]">Time: 10:14 AM</p>
                 </div>
               </div>
               <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 flex gap-3 items-center opacity-70">
                 ...
                 <div>
                   ...
                   <p className="text-slate-600 text-xs">Camera: Entry A</p>
                 </div>
               </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 bg-slate-50/50 backdrop-blur-md border border-slate-200 rounded-2xl p-6 flex flex-col">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2"><Camera size={20} className="text-blue-400"/> Live Drone & CCTV Feed</h3>
            <div className="flex gap-2">
              <span className="bg-red-500 px-2 py-1 rounded text-[10px] text-white font-bold animate-pulse">LIVE</span>
              <select className="bg-white border border-slate-200 text-slate-600 text-xs rounded px-2">
          ...
          <div className="flex-1 bg-slate-50 rounded-xl border border-slate-200 relative overflow-hidden group">
            ...
            <div className="absolute inset-0 p-4 flex flex-col justify-between pointer-events-none">
              <div className="flex justify-between">
                ...
                <div className="text-slate-600 font-mono text-xs drop-shadow-md text-right">
          ...
          <div className="grid grid-cols-4 gap-4 mt-4">
            {[1,2,3,4].map(i => (
              <div key={i} className={`h-20 bg-white rounded-lg border cursor-pointer hover:border-blue-500 transition-colors ${i === 1 ? 'border-blue-500' : 'border-slate-200'}`}>
