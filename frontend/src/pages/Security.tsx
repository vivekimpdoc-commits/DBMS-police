        ...
        <div className="glass-card rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="bg-slate-800/50 border border-slate-700 rounded-xl p-4 flex justify-between items-center">
                <div>
        ...
        <div className="glass-card rounded-2xl p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Search vehicle..." className="pl-8 pr-3 py-1 bg-slate-800 border border-slate-700 rounded text-xs text-white placeholder-slate-500 w-40 focus:outline-none focus:border-blue-500" />
            </div>
          </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-sm">
                <tr className="border-b border-white/5">
                  ...
                  <td className="py-3 text-slate-400">Pilot 1 (Gypsy)</td>
