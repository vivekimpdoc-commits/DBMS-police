    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Manage Advance Security Liaison (ASL) reports and escort vehicles.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-50/50 backdrop-blur-md border border-slate-200 rounded-2xl p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2"><FileCheck size={20} className="text-blue-400"/> Anti-Sabotage Check (ASL)</h3>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="bg-white/50 border border-slate-200 rounded-xl p-4 flex justify-between items-center">
                <div>
                  <h4 className="text-slate-800 font-bold text-sm">{asl.venue}</h4>
                  <p className="text-xs text-slate-500">By: {asl.by} | Time: {asl.time}</p>
                </div>
        ...
        <div className="bg-slate-50/50 backdrop-blur-md border border-slate-200 rounded-2xl p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2"><Car size={20} className="text-blue-400"/> Vehicle & Fleet</h3>
            <div className="relative">
              <Search className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 w-4 h-4" />
              <input type="text" placeholder="Search vehicle..." className="pl-8 pr-3 py-1 bg-white border border-slate-200 rounded text-xs text-slate-800 w-40" />
            </div>
          </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-sm">
                <tr className="border-b border-slate-200/50">
                  ...
                  <td className="py-3 text-slate-600">Pilot 1 (Gypsy)</td>
                  <td className="py-3 text-slate-800">HC Ramesh (98765...)</td>
                ...
                <tr className="border-b border-slate-200/50">
                  ...
                  <td className="py-3 text-slate-600">Escort 1 (Innova)</td>
                  <td className="py-3 text-slate-800">SI Suresh (98765...)</td>
                  <td className="py-3"><span className="text-xs bg-emerald-500/10 text-emerald-400 px-2 py-1 rounded">Active</span></td>
                </tr>
                <tr className="border-b border-slate-200/50">
                  <td className="py-3 font-mono text-blue-400">UP32 POL 005</td>
                  <td className="py-3 text-slate-600">Jammer Vehicle</td>
                  <td className="py-3 text-slate-800">Insp. Technical</td>
